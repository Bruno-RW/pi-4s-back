...
export function avgRainLvlByMonth(data) {
  return avgByMonth(data, 'emw_rain_lvl');
}

export function avgTempByMonth(data) {
  return avgByMonth(data, 'emw_temperature');
}

export function avgHumidByMonth(data) {
  return avgByMonth(data, 'emw_humidity');
}